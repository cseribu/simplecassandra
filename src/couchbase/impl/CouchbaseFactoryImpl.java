...
public class CouchbaseFactoryImpl extends EFactoryImpl implements CouchbaseFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CouchbasePackage.ESTIRNG_TO_DOCUMENT: return (EObject)createEStirngToDocument();
	 ...
	 * @generated
	 */
	public Map.Entry<String, Document> createEStirngToDocument() {
		EStirngToDocumentImpl eStirngToDocument = new EStirngToDocumentImpl();
		return eStirngToDocument;
	}
