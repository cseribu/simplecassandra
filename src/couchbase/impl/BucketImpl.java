...
public class BucketImpl extends MinimalEObjectImpl.Container implements Bucket {
	 ...
	 * @ordered
	 */
	protected EList<Map.Entry<String, Document>> documents;
	 ...
	 * @generated
	 */
	public EList<Map.Entry<String, Document>> getDocuments() {
		if (documents == null) {
			documents = new EObjectResolvingEList<Map.Entry<String, Document>>(Entry.class, this, CouchbasePackage.BUCKET__DOCUMENTS);
		}
		return documents;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CouchbasePackage.BUCKET__DOCUMENTS:
				getDocuments().clear();
				getDocuments().addAll((Collection<? extends Map.Entry<String, Document>>)newValue);
				return;
		}
