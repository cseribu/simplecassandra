...
public class CouchbasePackageImpl extends EPackageImpl implements CouchbasePackage {
	 ...
	 * @generated
	 */
	private EClass eStirngToDocumentEClass = null;
	 ...
	 * @generated
	 */
	public EClass getEStirngToDocument() {
		return eStirngToDocumentEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEStirngToDocument_Key() {
		return (EAttribute)eStirngToDocumentEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getEStirngToDocument_Value() {
		return (EReference)eStirngToDocumentEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		eStirngToDocumentEClass = createEClass(ESTIRNG_TO_DOCUMENT);
		createEAttribute(eStirngToDocumentEClass, ESTIRNG_TO_DOCUMENT__KEY);
		createEReference(eStirngToDocumentEClass, ESTIRNG_TO_DOCUMENT__VALUE);
	...
	public void initializePackageContents() {
		...
		initEReference(getJSONObject_Map(), this.getEStringToJSONElement(), null, "map", null, 1, 1, JSONObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBucket_Documents(), this.getEStirngToDocument(), null, "documents", null, 1, 1, Bucket.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(eStirngToDocumentEClass, Map.Entry.class, "EStirngToDocument", !IS_ABSTRACT, !IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEStirngToDocument_Key(), ecorePackage.getEString(), "key", null, 1, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEStirngToDocument_Value(), this.getDocument(), null, "value", null, 1, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadata_Rev(), ecorePackage.getEInt(), "rev", null, 1, 1, Metadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMetadata_Flags(), ecorePackage.getEString(), "flags", null, 1, 1, Metadata.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
