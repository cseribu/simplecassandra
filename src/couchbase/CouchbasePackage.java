...
public interface CouchbasePackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link couchbase.impl.EStirngToDocumentImpl <em>EStirng To Document</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see couchbase.impl.EStirngToDocumentImpl
	 * @see couchbase.impl.CouchbasePackageImpl#getEStirngToDocument()
	 * @generated
	 */
	int ESTIRNG_TO_DOCUMENT = 11;
	 ...
	 * @ordered
	 */
	int ESTIRNG_TO_DOCUMENT__KEY = 0;
	 ...
	 * @ordered
	 */
	int ESTIRNG_TO_DOCUMENT__VALUE = 1;

	/**
	 * The number of structural features of the '<em>EStirng To Document</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ESTIRNG_TO_DOCUMENT_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>EStirng To Document</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ESTIRNG_TO_DOCUMENT_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the reference '{@link couchbase.JSONObject#getMap <em>Map</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link couchbase.Bucket#getDocuments <em>Documents</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link java.util.Map.Entry <em>EStirng To Document</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>EStirng To Document</em>'.
	 * @see java.util.Map.Entry
	 * @model keyDataType="org.eclipse.emf.ecore.EString" keyRequired="true"
	 *        valueType="couchbase.Document" valueRequired="true"
	 * @generated
	 */
	EClass getEStirngToDocument();
	 ...
	 * @return the meta object for the attribute '<em>Key</em>'.
	 * @see java.util.Map.Entry
	 * @see #getEStirngToDocument()
	 * @generated
	 */
	EAttribute getEStirngToDocument_Key();
	 ...
	 * @generated
	 */
	EReference getEStirngToDocument_Value();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link couchbase.impl.EStirngToDocumentImpl <em>EStirng To Document</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see couchbase.impl.EStirngToDocumentImpl
		 * @see couchbase.impl.CouchbasePackageImpl#getEStirngToDocument()
		 * @generated
		 */
		EClass ESTIRNG_TO_DOCUMENT = eINSTANCE.getEStirngToDocument();
		 ...
		 * @generated
		 */
		EAttribute ESTIRNG_TO_DOCUMENT__KEY = eINSTANCE.getEStirngToDocument_Key();
		 ...
		 * @generated
		 */
		EReference ESTIRNG_TO_DOCUMENT__VALUE = eINSTANCE.getEStirngToDocument_Value();
