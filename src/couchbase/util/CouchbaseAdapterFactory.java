...
public class CouchbaseAdapterFactory extends AdapterFactoryImpl {
	...
	protected CouchbaseSwitch<Adapter> modelSwitch =
		new CouchbaseSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEStirngToDocument(Map.Entry<String, Document> object) {
				return createEStirngToDocumentAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>EStirng To Document</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEStirngToDocumentAdapter() {
		return null;
	}
