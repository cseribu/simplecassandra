...
public class CouchbaseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CouchbasePackage.ESTIRNG_TO_DOCUMENT: {
				@SuppressWarnings("unchecked") Map.Entry<String, Document> eStirngToDocument = (Map.Entry<String, Document>)theEObject;
				T result = caseEStirngToDocument(eStirngToDocument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EStirng To Document</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EStirng To Document</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEStirngToDocument(Map.Entry<String, Document> object) {
		return null;
	}
